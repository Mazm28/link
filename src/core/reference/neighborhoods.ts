...
const DEFS: Record<string, readonly string[]> = {
  mashhad: [
    'احمدآباد', 'کوه سنگی', 'آزادشهر', 'الهیه', 'شهرک غرب', 'خواجه ربیع',
    'آبکوه', 'وکیل‌آباد', 'طبرسی شمالی', 'کوی سیدی', 'پروین اعتصامی',
    'جاهد شهر', 'بلال', 'پورسینا', 'کوی ولیعصر', 'هفت تیر', 'عبادی',
    'ایثارگران', 'قاسم‌آباد', 'سجاد',
  ],
  isfahan: [
    'ملک‌شهر', 'سپاهان‌شهر', 'بهارستان', 'ملاصدرا', 'باغ فردوس', 'دستگرده',
    'کوی امیریه', 'ارزنان', 'شاهزاده ابراهیم', 'مهدی‌آباد', 'فروردین',
    'چرخاب', 'قلعه طبرره', 'پوریای ولی', 'مارچین', 'خانه اصفهان',
    'رهنان', 'زینبیه',
  ],
  karaj: [
    'عظیمیه', 'گوهردشت', 'گلشهر', 'حصار', 'حسن‌آباد', 'شهرک امام رضا',
    'فاز ۳ گوهردشت', 'کرج نو', 'کلاک نو', 'پیشاهنگی', 'اتحاد', 'شهرک ظفر',
    'مهرشهر', 'جهانشهر',
  ],
  shiraz: [
    'قصرالدشت', 'ارم', 'فرهنگ‌شهر', 'ستارخان', 'معالی‌آباد', 'زرهی',
    'شهرک گلها', 'شهرک بهشتی', 'دکتر حسابی', 'فضل‌آباد', 'شریف‌آباد',
    'کوشک بیدک', 'تحویلی', 'فخرآباد', 'ریشمک', 'وصال', 'دارالرحمه',
    'شیخ علی چوپان', 'مسلم', 'درکی', 'آبیاری',
  ],
};
...
export const OTHER_CITY_NEIGHBORHOODS: readonly Neighborhood[] = Object.keys(DEFS).flatMap(buildFor);
