...
An activity with no fixed start — *"looking for a squash partner this month"*, *"anyone up for weekly Persian conversation practice?"*. Today every activity must carry a `startsAt`, so such a post either gets a fake date or cannot be made.
...
| **`canRate`** — *"the activity date has passed"* (BR-U4-61) | ⚠️ **Rating can never open.** Attending an open-ended activity would earn nobody any reputation, which quietly makes them second-class: all of the meeting risk, none of the reputation reward. |
